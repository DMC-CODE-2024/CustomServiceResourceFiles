...
INSERT IGNORE INTO sys_param (tag, value, feature_name  ) VALUES ('CustomAuthApiUrlPath', 'https://stage-gateway.customs.gov.kh/dmc-interface/api/v1/oauth/token', 'CustomCheckImei' );
INSERT IGNORE INTO sys_param (tag, value, feature_name  ) VALUES ('CustomAuthApiClientId', '2', 'CustomCheckImei' );
INSERT IGNORE INTO sys_param (tag, value, feature_name  ) VALUES ('CustomAuthApiSecretKey', 'QNzhRKixNfStVkomv5S1XsQdgb3ufgAiktF2wPMz', 'CustomCheckImei');
INSERT IGNORE INTO sys_param (tag, value, feature_name  ) VALUES ('CustomCheckImeiApiUrlPath', 'https://stage-gateway.customs.gov.kh/dmc-interface/api/v1/imei-tax-check', 'CustomCheckImei' );
INSERT IGNORE INTO sys_param (tag, value, feature_name  ) VALUES ('CamDxLayerHeaderName', 'X-Road-Client', 'CustomCheckImei');
INSERT IGNORE INTO sys_param (tag, value, feature_name  ) VALUES ('CamDxLayerHeaderValue', 'CAMBODIA/GOV/CAMDX-20201222/GDCE_EIRS_TEST', 'CustomCheckImei');

insert IGNORE into sys_param(tag , value,feature_name)values ( 'gdce_register_imei_update_last_run_time' , '2020-01-01' , 'CustomCheckImei');
